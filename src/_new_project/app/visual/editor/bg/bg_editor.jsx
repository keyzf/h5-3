...
import BgHeightForm from '../../../../../_new_ui/background/bg_height.form';
...
export default class BgEditor extends PureComponent {
  ...
  changeBgImgToChild = url => {
    const $$bg_new = this.props.bg_ui_value.data.setIn(['customize', 'img'], url);
   ...
   */
  delete = () => {
    const $$bg_new = this.props.bg_ui_value.data.setIn(['customize', 'img'], '');
