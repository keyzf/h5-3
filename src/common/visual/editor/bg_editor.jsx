...
class BgEditor extends PureComponent {
  ...
  closeModal = (state, data) => {
    ...
    if (state && data !== undefined) {
      ...
      const $$bg_crop_img = $$bg_new.setIn(
        ["customize", "crop_img"],
        data
      );
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          {$$crop_img ? (
            ...
            <React.Fragment>
              ...
              <div className={"bg_editor-img-show"} onClick={this.showModal}>
                <img className={"bg_editor-img"} src={$$crop_img} alt={"img"}/>
              </div>
              {/*显示操作栏*/}
              <div className={"bg_editor-editor"}>
                ...
                <div className={"bg_editor-change"}>
                  <div className={"bg_editor-change"} onClick={this.crop_showModal}>
                    裁剪
                  </div>
                </div>
                <Divider type="vertical"/>
          ...
          <ImgCrop crop_visible={this.state.crop_visible}
