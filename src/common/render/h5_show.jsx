        ...
        <div style={{ width: "100%", height: "100vh",overflow:'auto' }}>
          {select_data.map((ui_data, index) => {
            const advanced_settings = {
              // 动画移动
              transformX: ui_data.getIn(["advance", "transform", "translateX", "value"]),
              transformY: ui_data.getIn(["advance", "transform", "translateY", "value"]),
              // 周长
              width: ui_data.getIn(["advance", "perimeter", "width", "value"]),
              height: ui_data.getIn(["advance", "perimeter", "height", "value"]),
              // 颜色
              bgColor: ui_data.getIn(["advance", "color"]),
              //背景
              img: ui_data.getIn(["advance", "img"]),
              //拉伸
              stretching: ui_data.getIn(["advance", "img_config", "stretching", "value"]),
              //平铺
