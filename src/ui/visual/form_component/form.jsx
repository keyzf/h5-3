      ...
      <FormLayoutAtom {...advanced_settings}>
        {this.props.choose ? (
          <div style={{ border: "1px grey solid" }}>
            <Form onSubmit={this.handleSubmit.bind(this)} layout={"vertical"} hideRequiredMark={true}>
                ...
                {customize.get("item").map((data, index) => {
                  return (
                    <div key={index}
                      ...
                      {
                        data.get("type") === "checkbox" ? <FormItem
                          {...form_item_style(`${data.get("title").get("value")}`)}
                        >
                          {getFieldDecorator(`${data.get("decorator")}`)(
                      ...
                      {
                        data.get("type") === "datePicker" ? <FormItem
                          {...form_item_style(`${data.get("title").get("value")}`)}
                        >
                          {getFieldDecorator(`${data.get("decorator")}`)(
