...
const template = fromJS([
  {
    type: "radio", title: { value: "item_one" }, decorator: "item_one", option: [
      "题目一",
      "题目二" ,
      "题目三" ,
      "题目四"
  ...
  {
    type: "radio", title: { value: "item_two" }, decorator: "item_two", option: [
      "题目一",
      "题目二" ,
      "题目三" ,
      "题目四"
  ...
  {
    type: "radio", title: { value: "item_three" }, decorator: "item_three", option: [
      "题目一",
      "题目二" ,
      "题目三" ,
      "题目四"
  ...
  {
    type: "radio", title: { value: "item_four" }, decorator: "item_four", option: [
      "题目一",
      "题目二" ,
      "题目三" ,
      "题目四"
