...
const $$img_addItem_database = fromJS({
  img: "http://demos.creative-tim.com/material-kit-pro/assets/img/image_placeholder.jpg",
  title: { value: "这里是图片标题" },
  content: {
...
// 1. 单张图片
const $$single_img_database = $$img_func_database("single_img", [
  {
...
// 2. 横排排列图
const $$grid_img_database = $$img_func_database("grid_img", [
  {
...
// 3. 竖排排列图
const $$list_img_database = $$img_func_database("list_img", [
  {
...
// 4. 滑动图
const $$slider_img_database = $$img_func_database("slider_img", [
  {
    img: "https://demos.creative-tim.com/material-kit-pro/assets/img/bg.jpg",
    title: { value: "这里是图片标题" },
    content: {
...
// 5. 轮播图
const $$carousel_img_database = $$img_func_database("carousel_img", [
  {
    img: "https://demos.creative-tim.com/material-kit-pro/assets/img/bg.jpg",
    title: { value: "这里是图片标题" },
    content: {
