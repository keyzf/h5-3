...
const $$one_mall_database = $$mall_func_database(
  ...
  [
    {
      img: "http://pimg.xiuzan.com/xiuzan/2017/01/20170118110355_8fNJ4b?x-oss-process=image/resize,w_116/format,png", //图片
      img_config: {
        stretching: { value: "" },
        tiling: { value: "" }
      }, //图片配置
    ...
    {
      img: "http://pimg.xiuzan.com/xiuzan/2017/01/20170118110830_m873dh?x-oss-process=image/resize,w_116/format,png", //图片
      img_config: {
        stretching: { value: "" },
        tiling: { value: "" }
      }, //图片配置
    ...
    {
      img: "http://pimg.xiuzan.com/xiuzan/2017/01/20170118113237_EdDfdc?x-oss-process=image/resize,w_116/format,png", //图片
      img_config: {
        stretching: { value: "" },
        tiling: { value: "" }
      }, //图片配置
...
// 导出模块
export { $$mall_item_database, $$grid_mall_database, $$list_mall_database, $$one_mall_database };
