...
const $$one_img_database = $$img_func_database(
  ...
  [
    {
      img: "http://pimg.xiuzan.com/xiuzan/2017/01/20170117160441_mfnkDr?x-oss-process=image/resize,w_116/format,jpg",
      title: { value: "居家办公" },
      content: {
    ...
    {
      img: "http://pimg.xiuzan.com/xiuzan/2017/01/20170117160450_hkfRNh?x-oss-process=image/resize,w_116/format,jpg",
      title: { value: "数码潮品" },
      content: {
        value: "苹果正在开发特别的东西"
      },
    ...
    {
      img: "http://pimg.xiuzan.com/xiuzan/2017/01/20170117160457_tGE6Ny?x-oss-process=image/resize,w_116/format,jpg",
      title: { value: "美食茶艺" },
      content: {
    ...
    {
      img: "http://pimg.xiuzan.com/xiuzan/2017/01/20170117160514_76XecX?x-oss-process=image/resize,w_116/format,jpg",
      title: { value: "音乐达人" },
      content: {
