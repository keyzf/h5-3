...
class VideoListUI extends React.Component {
  state = {
    ajax_url: [
      { dsc: "视频一", url: 'https://e7wei-img.oss-cn-beijing.aliyuncs.com/movie.mp4' },
      { dsc: "视频二", url: 'https://e7wei-img.oss-cn-beijing.aliyuncs.com/movie.mp4' },
      { dsc: "视频三", url: 'https://e7wei-img.oss-cn-beijing.aliyuncs.com/movie.mp4' },
      { dsc: "视频四", url: 'https://e7wei-img.oss-cn-beijing.aliyuncs.com/movie.mp4' },
      { dsc: "视频五", url: 'https://e7wei-img.oss-cn-beijing.aliyuncs.com/movie.mp4' },
      { dsc: "视频六", url: 'https://e7wei-img.oss-cn-beijing.aliyuncs.com/movie.mp4' }
    ]
  };
  // 在渲染之前,通过ajax 获取数据
  // componentDidMount() {
        ...
        {this.state.ajax_url.map((data, index) => {
          return (
            <Row key={index} className={"components_hover"}
                 onClick={this.transfer.bind(this, $$video_database("video", data.url))}>
              <Col span={8}>
                {data.dsc}
              </Col>
              <Col span={8}>
