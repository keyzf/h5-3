...
const $$three_text = fromJS(
  $$text_database("three_text", three_html_text, 37)
);
const $$four_text = fromJS(
  $$text_database("four_text", four_html_text, 37)
);
const $$five_text = fromJS(
  $$text_database("five_text", five_html_text, 47)
);
const $$six_text = fromJS($$text_database("six_text", six_html_text, 47));
const $$seven_text = fromJS(
  $$text_database("seven_text", seven_html_text, 40)
);
const $$eight_text = fromJS(
  $$text_database("eight_text", eight_html_text, 47)
);
const $$nine_text = fromJS(
  $$text_database("nine_text", nine_html_text, 34)
);
