...
const $$vertical_text = fromJS($$text_database("vertical_text", v_html_text, 320, 147));
...
const $$three_text = fromJS($$text_database("three_text", three_html_text, 244, 37));
const $$four_text = fromJS($$text_database("four_text", four_html_text, 244, 37));
const $$five_text = fromJS($$text_database("five_text", five_html_text, 300, 47));
const $$six_text = fromJS($$text_database("six_text", six_html_text, 300, 47));
const $$seven_text = fromJS($$text_database("seven_text", seven_html_text, 144, 40));
const $$eight_text = fromJS($$text_database("eight_text", eight_html_text, 100, 47));
const $$nine_text = fromJS($$text_database("nine_text", nine_html_text, 300, 34));
const $$ten_text = fromJS($$text_database("ten_text", ten_html_text, 300, 34));
const $$eleven_text = fromJS($$text_database("eleven_text", eleven_html_text, 280, 35));
const $$twelve_text = fromJS($$text_database("twelve_text", twelve_html_text, 300, 36));
