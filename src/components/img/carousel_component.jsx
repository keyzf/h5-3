                          ...
                          return (
                            <div key={index}>
                              <img width={data.get("width").get("value") ? data.get("width").get("value") : "100%"}
                                   ...
                                   alt={"img"}/>
                              <div style={{ marginTop: "-100px", position: "relative", top: "-30px" }}>
                                {
                    ...
                    customize.get("item").map((data, index) => {
                        return (
                          <div key={index}>
                            ...
                            <div style={{ marginTop: "-100px", position: "relative", top: "-30px" }}>
                              {
                                customize.get("base").get("show_element").get("value") === "title" || customize.get("base").get("show_element").get("value") === "both" ? "" :
                                  <div style={{
                                    display: "flex",
                                    justifyContent: "center",
                                    alignItems: "center"
                              ...
                              {
                                customize.get("base").get("show_element").get("value") === "content" || customize.get("base").get("show_element").get("value") === "both" ? "" :
                                  <div style={{
                                    display: "flex",
                                    justifyContent: "center",
                                    alignItems: "center"
...
// hoc 包装组件
export default connect("", mapDispatchToProps)(CarouselImgComponent);
