...
import { render_component } from "../../model/render/components";
...
class ContentVisualView extends PureComponent {
  render() {
    ...
    return (
      //visual content 内容栏
      <div id={"content_root"} className={"visual_content-template"}>
        <BgComponent {...bg_config}>
          ...
          {choose_meta.get("content") ?
            ...
            :
            <div className={"visual_content-default"}>请从左侧选择组件~</div>
          }
        </BgComponent>
      </div>
    );
