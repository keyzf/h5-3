              ...
              <FormItem {...form_item_style('阴影')}>
                {getFieldDecorator('shadow')(
                  <Select showSearch placeholder="选择阴影层次">
                    ...
                    <Option value="0 8px 17px 2px rgba(0,0,0,0.14), 0 3px 14px 2px rgba(0,0,0,0.12), 0 5px 5px -3px rgba(0,0,0,0.2)">
                      二级
                    </Option>
                    <Option value="0 16px 24px 2px rgba(0,0,0,0.14), 0 6px 30px 5px rgba(0,0,0,0.12), 0 8px 10px -7px rgba(0,0,0,0.2)">
                      三级
                    </Option>
                    <Option value="0 24px 38px 3px rgba(0,0,0,0.14), 0 9px 46px 8px rgba(0,0,0,0.12), 0 11px 15px -7px rgba(0,0,0,0.2)">
                      四级
                    </Option>
                  </Select>
                )}
