...
import { $$mall_database, $$mall_item_database } from "../../../../database/components/mall";
        ...
        {this.state.item ? (
          ...
          <Tabs defaultActiveKey={"1"} tabBarExtraContent={operations} key={1}>
            <Tabs.TabPane tab="内容设置" key="1">
              ...
              <Card title="项目列表" extra={<div onClick={this.editorFeatures.bind(this, "add_item")}>
                <Icon type="plus"/>添加
              </div>}>
