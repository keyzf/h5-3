    ...
    return (
      ...
      <React.Fragment>
          ...
          {$$img ? (
            ...
            <React.Fragment>
              ...
              >
                ...
                >
                  <Popconfirm placement="top" title={"确认删除此背景图?"} onConfirm={this.delete} okText="确认" cancelText="取消">
                    删除
                  </Popconfirm>
                </div>
                <Checkbox
        ...
        <Card {...card_style("背景色配置")}>
          ...
          <Popover
            content={<SketchPicker color={$$color} onChangeComplete={this.bg_color_config}/>}
            trigger="click"
            placement="left"
          >
            <Card.Grid
