    ...
    return (
      <QueueAnim delay={200}>
        ...
        <div
          ...
          onClick={this.transfer.bind(
            this,
            option_data('one_text', one_html_text)
          )}
        >
          <OneTextTemplate />
        </div>
        <div
          ...
          onClick={this.transfer.bind(
            this,
            option_data('two_text', two_html_text)
          )}
        >
          <TwoTextTemplate />
        </div>
        <div
          ...
          onClick={this.transfer.bind(
            this,
            option_data('three_text', three_html_text)
          )}
        >
          <ThreeTextTemplate />
        </div>
        <div
          ...
          onClick={this.transfer.bind(
            this,
            option_data('four_text', four_html_text)
          )}
        >
          <FourTextTemplate />
        </div>
        <div
          ...
          onClick={this.transfer.bind(
            this,
            option_data('five_text', five_html_text)
          )}
        >
          <FiveTextTemplate />
        </div>
        <div
          ...
          onClick={this.transfer.bind(
            this,
            option_data('six_text', six_html_text)
          )}
        >
          <SixTextTemplate />
        </div>
        <div
          ...
          onClick={this.transfer.bind(
            this,
            option_data('seven_text', seven_html_text)
          )}
        >
          <SevenTextTemplate />
        </div>
