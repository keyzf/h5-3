...
import {
  ...
  $$grid_img_database,
  $$list_img_database, $$one_img_database,
  $$single_img_database,
  $$slider_img_database
...
import {
  $$grid_mall_database,
  $$list_mall_database, $$one_mall_database
...
const template_img_data = [
  ...
  { template: "", data: "dividing-line" },
  { template: <OneImgUi data={$$one_img_database}/>, data: $$one_img_database }
];
...
const template_music_data = [
  {
    ...
    data: $$music_database("music", "https://e7wei-img.oss-cn-beijing.aliyuncs.com/music.mp3")
  },
  { template: "", data: "dividing-line" },
