...
import {
  $$carousel_img_database, $$four_img_database,
  $$grid_img_database,
  $$list_img_database,
  $$one_img_database,
  $$single_img_database,
...
const template_text_data = [
  ...
  { template: <NineTeenTextUi html={nineteen_html_text}/>, data: $$nineteen_text },
...
const template_img_data = [
  ...
  { template: <FourImgUi data={$$four_img_database}/>, data: $$four_img_database }
];
/**
 * music
 * @type {*[]}
