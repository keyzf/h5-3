...
class BgEditor extends PureComponent {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        {/*背景图栏*/}
        <Card title={"背景图"} className={style.card} extra={<div onClick={this.showModal}>
          <Icon type="plus"/>
          上传图片
        </div>}>
          {/*判断背景图是否存在*/}
          {$$crop_img ? (
            ...
            <React.Fragment>
              ...
              <div className={style.editor}>
                ...
                <div className={style.editor_click}>
                  <div className={style.editor_click} onClick={this.crop_showModal}>
                    裁剪
                  </div>
                </div>
                <Divider type="vertical"/>
            ...
            <div
              ...
              className={style.bg_transparent}
            />
          )}
          <UpImgPart
