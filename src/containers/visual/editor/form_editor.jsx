    ...
    return (
      <Fragment>
        {this.state.item ? (
          ...
          >
            {
              $$customize.getIn(["item", this.state.number, 'type']) === "radio" ?
                <React.Fragment>
                  <Form>
                  ...
                  {$$customize.getIn(["item", this.state.number, "option"]).map((data, inside_index) => {
                    return (
            ...
            {
              $$customize.getIn(["item", this.state.number, 'type']) === "input" ?
                <React.Fragment>
                  <Form>
                    <Form.Item {...form_item_style("标题")}>
                      <Input
                  ...
                  <Form>
                    <Form.Item {...form_item_style("内容")}>
                      <Input
                        defaultValue={$$customize.getIn(["item", this.state.number, "option", "value"])}
            ...
            {
              $$customize.getIn(["item", this.state.number, 'type']) === "rate" ?
                <React.Fragment>
                  <Form>
                    <Form.Item {...form_item_style("标题")}>
                      <Input
            ...
            {
              $$customize.getIn(["item", this.state.number, 'type']) === "checkbox" ?
                <React.Fragment>
                  <Form>
                    <Form.Item {...form_item_style("标题")}>
                      <Input
            ...
            {
              $$customize.getIn(["item", this.state.number, 'type']) === "datePicker" ?
                <React.Fragment>
                  <Form>
                    <Form.Item {...form_item_style("标题")}>
                      <Input
