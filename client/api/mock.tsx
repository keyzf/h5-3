...
//  */
// Mock.mock(
//   `${window.location.origin}/Material/getUser`,
//   "post",
//   JSON.stringify({
//     error: 0,
//     list: [
...
//  */
// Mock.mock(
//   `${window.location.origin}/Material/delUser`,
//   "post",
//   JSON.stringify({
//     error: 0,
//     list: [
...
//  */
// Mock.mock(
//   `${window.location.origin}/Material/addUser`,
//   "post",
//   JSON.stringify({
//     error: 0,
...
//  */
// Mock.mock(
//   `${window.location.origin}/Material/getSysType`,
//   "post",
//   JSON.stringify({
//     error: 0,
//     list: [
...
//  */
// Mock.mock(
//   `${window.location.origin}/Material/getSys`,
//   "post",
//   JSON.stringify({
//     error: 0,
//     list: [{ url: "http://s.e7wei.com/811284QY8FA48F2.mp3", name: "奏响舞曲" },
