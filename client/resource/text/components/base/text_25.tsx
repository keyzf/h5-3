...
class Text25 extends React.PureComponent<Props, ""> {
    render() {
        ...
        return <div>
            <section className={style.text23c1} style={{borderBottom: ` 1px solid ${base.color }`}}/>
            <section className={style.text23c2} style={{borderLeft: ` 1px solid ${base.color }`}}/>
            ...
            <section className={style.text23c5}>
                <section className={style.text23c6} style={{borderRight: ` 1px solid ${base.color }`}}/>
                <section className={style.text23c7} style={{borderBottom: ` 1px solid ${base.color }`}}/>
            </section>
        </div>;
    }
}
