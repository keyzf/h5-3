...
class Text33 extends React.PureComponent<Props, ""> {
    render() {
        ...
        return <section className={style.text31c1}>
            <section className={style.text31c2}>
                <section className={style.text31c3}>
                    <section className={style.text31c4} style={{borderColor: ` ${base.color } `}}/>
                    <section className={style.text31c5} style={{borderColor: ` ${base.color } `}}/>
                </section>
                <section className={style.text31c6} style={{border: ` 2px solid ${base.color } `}}>
