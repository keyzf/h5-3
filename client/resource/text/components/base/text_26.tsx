...
class Text26 extends React.PureComponent<Props, ""> {
  render() {
    ...
    return (
      <section className={style.text24c1}>
        <section className={style.text24c2}>
          <section
            className={style.text24c3}
            style={{ borderColor: `${base.color}` }}
          />
          <section
            className={style.text24c4}
            style={{ borderColor: `${base.color}` }}
          />
          <section className={style.text24c5} />
        </section>
        <section
          className={style.text24c6}
        ...
        <section className={style.text24c8}>
          <section
            className={style.text24c9}
            style={{ borderColor: `${base.color}` }}
          />
          <section
            className={style.text24c10}
            style={{ borderColor: `${base.color}` }}
          />
        </section>
      </section>
