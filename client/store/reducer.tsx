    ...
    case "INIT":
      return produce(state, (draftState: Store) => {
        ...
        draftState.global.self = draftState.global.self
          ? payload.info.self
          : "";
        draftState.share.title = draftState.share.title
          ? payload.info.title
          : "标题";
        draftState.share.desc = draftState.share.desc
          ? payload.info.desc
          : "内容";
        draftState.share.cover = draftState.share.cover
          ? payload.info.cover
          : "";
        if (payload.info.version !== "1") {
          draftState.bg = draftState.bg ? payload.info.bg : BgData;
          draftState.ui = draftState.ui ? payload.info.ui : [];
          draftState.music = draftState.music
            ? payload.info.music
            : { desc: "", url: "" };
        } else {
